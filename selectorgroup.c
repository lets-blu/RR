...
{
    SelectorGroup group = {
        .subject.registerObserver = (register_observer_fp)registerObserverToSelectorGroup,
        .subject.removeObserver = (remove_observer_fp)removeObserverFromSelectorGroup,
        .subject.notifyAllObservers = (notify_observers_fp)notifyAllSelectorGroupObservers,
...
{
    if (pThis->_observers != NULL && pThis->_numOfObservers < pThis->_totalOfObservers)
    {
